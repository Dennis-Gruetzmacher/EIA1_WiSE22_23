...
var currentPopEU: number = 447.01; /*Gesamtbevölkerung der EU*/
var baselineYear: number = 2008; /*Baseline Jahr = Vergleichsjahr*/
/************Arrays***********/
var nameCountry: string [] = ["Deutschland", "Frankreich", "Italien", "Niederlande"]; /*Ländernamen*/
var currentPopCountry: number[] = [83.24, 67.39, 59.55, 17.44]; /*Aktuelle Bevölkerungszahl*/
var baselinePopCountry: number [] = [82.11, 64.37, 58.83, 16.45]; /*Bevölkerungszahl im baseline Jahr*/
var currentGrowth: number[] = []; /*leeres Array vorbereitet für die Berechnung des prozentualen Wachstums*/
var currentPercentage: number[] = []; /*leeres Array vorbereitet für die Berechnung des Prozentualen Anteils*/
var absoluteGrowth: number[] = []; /*leeres array vorbereitet für die Berechnung des absoluten Wachstums*/
