...
(function (Aufgabe10) {
    ...
    /*****************************************************/
    let generalTaskID = 0; //Genereller Taskzähler
    let arrayTasks = []; //leeres Array für die Task Objekte vorbereitet
    let activeCreationIndex; //vorbereitet für Erschaffung neuer Objekte
    ...
    function triggerStatus() {
        ...
        if (arrayTasks[activeArrayIndex].status == true) { //Wenn der Status des aktiven Objekts = true
    ...
    function calculateNumberTasks() {
        ...
        else if (numberTasks == 1) //Sonderfall wenn nur ein Task vorhanden
         {
